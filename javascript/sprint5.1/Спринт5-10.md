...
Объявим функцию <span class="element-hint" data-test-id="element-hint"><span class="element-hint__wrapper glossary-term">`keepScore`</span></span>, которая сообщает итог матча. Она принимает два параметра — <span class="element-hint" data-test-id="element-hint"><span class="element-hint__wrapper glossary-term">`ours`</span></span> и <span class="element-hint" data-test-id="element-hint"><span class="element-hint__wrapper glossary-term">`theirs`</span></span>. Это число голов, забитое «нашими» и соперником.
...
Функциям обычно поручают преобразовывать данные, но не определять, где они применяются — в консоли, во всплывающем окне или где-то ещё. Преобразованные данные возвращаются скрипту для дальнейшего использования.

</div>

<div class="paragraph">

Возвращаемые значения указывает оператор <span class="element-hint" data-test-id="element-hint"><span class="element-hint__wrapper glossary-term">`return`</span></span>:
...
Что такое `undefined` мы расскажем позже.
